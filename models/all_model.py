...
from utils.layers import full_layer, conv_layer, mse, sigmoidCE, config
...
class CNN(object):
    ...
    def train(self, train_batches, valid_set=None, 
        ...
        for i in range(n_epoch):
            loss_train_sum = 0.0
            loss_valid_sum = 0.0
            for images, _, _, _, _, _, all_attr in train_batches:
    ...
    def test(self):
        ...
        try:
            ...
            ckpt = os.path.join('all_model', 'model.ckpt')
